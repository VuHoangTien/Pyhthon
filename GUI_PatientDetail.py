...
class PatientDetailGui():
    def __init__(self, master, patient_data=None, navigation_callback=None):
    ...
    def save_patient(self, show_message=True):
        ...
        # Thực hiện lưu (ở đây chỉ hiển thị thông báo)
        if show_message:
            messagebox.showinfo("Thành công", "Đã lưu thông tin bệnh nhân thành công!")
        
        # Cập nhật patient_data với dữ liệu mới
    ...
    def delete_patient(self):
        ...
        if result:
            # Thực hiện xóa (ở đây chỉ hiển thị thông báo)
            messagebox.showinfo("Thành công", "Đã xóa thông tin bệnh nhân!")
